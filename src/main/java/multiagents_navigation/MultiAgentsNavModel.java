...
public class MultiAgentsNavModel extends GridWorldModel {
    ...
    public MultiAgentsNavModel(LocalizationMap map, MapType mapType) {
        ...
        for (int i = 0; i < agentStartsSize; i++) {
            this.setAgPos(i, agentStarts.get(i));
        }
//        randomAgentSpawn(this.width,this.height,this.nbAgts);
    }

    public static MultiAgentsNavModel loadFromFile(MapType mapType) {
        Gson gson = new Gson();
        ...
        return new MultiAgentsNavModel(map, mapType);
    }
