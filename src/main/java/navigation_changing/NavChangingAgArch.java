...
public class NavChangingAgArch extends AgArchEpistemic {

    NavChangingModel model = null;

    int myId = -1;

    protected Logger logger = Logger.getLogger(NavChangingAgArch.class.getName());
