...
public class MapEvent extends EventObject {
    ...
    private final NavChangingModel source;
    private final Location newLocation;
    private final Direction moveDirection;
    private final TypeEvent typeEvent;
    private final Integer agentId;

    public MapEvent(NavChangingModel source, Location newLocation, Direction direction, TypeEvent typeEvent, int ag) {
        super(source);
        this.source = source;
    ...
    @Override
    public NavChangingModel getSource() {
        return source;
    }
}
